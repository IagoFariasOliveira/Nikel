...
document.getElementById("login-form").addEventListener("submit", function(e) {
    ...
    if(!account) {
        alert("Opps! Verifique o usuário e a senha.");
        return;
    }
...
function getAccount(key) {
    ...
    document.getElementById("register-modal").addEventListener("submit", function(event) {
        ...
        if ("password-create-input" !== "confirm-password-input") {
          
            document.getElementById("confirm-password-error").textContent = "As senhas não são iguais";
